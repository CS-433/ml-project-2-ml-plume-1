...
for i in Picts_d1_train:
    new_path = os.path.join(r"E:\Dataset_3k\Training_set", i[15:])
    shutil.copyfile(i, new_path)
    
Picts_d1_valid = Picts_rand[1000:2000]
for i in Picts_d1_valid:
    new_path = os.path.join(r"E:\Dataset_3k\Validation_set", i[15:])
    shutil.copyfile(i, new_path)
    
Picts_d1_test = Picts_rand[2000:3000]
for i in Picts_d1_test:
    new_path = os.path.join(r"E:\Dataset_3k\Testing_set", i[15:])
    shutil.copyfile(i, new_path)
...
for i in Picts_d2_train:
    new_path = os.path.join(r"E:\Dataset_15k\Training_set", i[15:])
    shutil.copyfile(i, new_path)
    
Picts_d2_valid = Picts_rand[5000:10000]
for i in Picts_d2_valid:
    new_path = os.path.join(r"E:\Dataset_15k\Validation_set", i[15:])
    shutil.copyfile(i, new_path)
    
Picts_d2_test = Picts_rand[10000:15000]
for i in Picts_d2_test:
    new_path = os.path.join(r"E:\Dataset_15k\Testing_set", i[15:])
    shutil.copyfile(i, new_path)
...
for i in Picts_d3_train:
    new_path = os.path.join(r"E:\Dataset_75k\Training_set", i[15:])
    shutil.copyfile(i, new_path)

Picts_d3_valid = Picts_rand[25000:50000]
for i in Picts_d3_valid:
    new_path = os.path.join(r"E:\Dataset_75k\Validation_set", i[15:])
    shutil.copyfile(i, new_path)
    
Picts_d3_test = Picts_rand[50000:75000]
for i in Picts_d3_test:
    new_path = os.path.join(r"E:\Dataset_75k\Testing_set", i[15:])
    shutil.copyfile(i, new_path)
